...
v_sound = 340; % speed of sound [m/s]
f = 220;
lambda = v_sound/f;

figure
subplot(2,2,1)
plot(0:1/constants.fs:constants.durationChord,soundMajorChordJust)
title('Root Major Chord (Just Tempered Scale): One Wavelength')
xlabel('t in seconds')
ylabel('Amplitude')
xlim([0 1/220]) 
subplot(2,2,2)
plot(0:1/constants.fs:constants.durationChord,soundMajorChordJust)
title('Root Major Chord (Just Tempered Scale): Ten Wavelengths')
xlabel('t in seconds')
ylabel('Amplitude')
xlim([0 (1/220)*10])
subplot(2,2,3)
plot(0:1/constants.fs:constants.durationChord,soundMajorChordEqual)
title('Root Major Chord (Equal Tempered Scale): One Wavelength')
xlabel('t in seconds')
ylabel('Amplitude')
xlim([0 1/220]) 
subplot(2,2,4)
plot(0:1/constants.fs:constants.durationChord,soundMajorChordEqual)
title('Root Major Chord (Equal Tempered Scale): Ten Wavelengths')
xlabel('t in seconds')
ylabel('Amplitude')
xlim([0 (1/220)*10]) 
...
figure
subplot(2,2,1)
plot(0:1/constants.fs:constants.durationChord,soundMinorChordJust)
title('Root Minor Chord (Just Tempered Scale): One Wavelength')
xlabel('t in seconds')
ylabel('Amplitude')
xlim([0 1/220]) 
subplot(2,2,2)
plot(0:1/constants.fs:constants.durationChord,soundMinorChordJust)
title('Root Minor Chord (Just Tempered Scale): Ten Wavelengths')
xlabel('t in seconds')
ylabel('Amplitude')
xlim([0 (1/220)*10])
subplot(2,2,3)
plot(0:1/constants.fs:constants.durationChord,soundMinorChordEqual)
title('Root Minor Chord (Equal Tempered Scale): One Wavelength')
xlabel('t in seconds')
ylabel('Amplitude')
xlim([0 1/220]) 
subplot(2,2,4)
plot(0:1/constants.fs:constants.durationChord,soundMinorChordEqual)
title('Root Minor Chord (Equal Tempered Scale): Ten Wavelengths')
xlabel('t in seconds')
ylabel('Amplitude')
xlim([0 (1/220)*10]) 
